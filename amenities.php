...
.about .watermark {top:-100px;}    
.watermark2 {display:none;}
.address, .gallery {display:none;}
.absec .container, footer {position:relative; z-index:2;}
.slick-slider .slick-arrow {z-index:5;}
#amenities .cursor {left:-160px;}
#amenities .arrows {display:none;}

@media (min-width:768px) and (max-width:991px) {
    
    .slidesWrap ul.myslides {width:325px;}
    .frame3 .wrapper2 {width:290px;}
    .frame3 .wrapper3 {top:55%; width:290px;}
    
    #amenities .cursor {display:none !important;}
div#amenities .cursor-arrow  {display:inline-block; vertical-align:bottom; transform:translate(0 ,0 );}
div#amenities .galArrowRight {margin-right:5px;}
div#amenities .cursor-arrow {opacity:1;}      
div#amenities .arrow::before {transform:translateY(-50%) rotate(45deg); left:10px; top:6px;}
div#amenities .arrow::after {transform:translateY(50%) rotate(-45deg); left:10px; top:15px;}

div#amenities .galArrowLeft .arrow::before {transform:translateY(-50%) rotate(-45deg); left:-2px; top:6px;}
div#amenities .galArrowLeft .arrow::after {transform:translateY(50%) rotate(45deg); left:-2px; top:15px;}
...
#amenities .arrows {display:block;}
 #amenities .slick-slider {margin-top:-70px;} 

}

    @media (max-width: 767px){
        
        .amenitiesbanner{background: url(images/amenities-mob.jpg) no-repeat;}
.slidesWrap ul.myslides {width:auto;}      
div#amenities  .slick-slider .slick-arrow {display:none;}
div#amenities {
    padding-bottom: 10px;
    margin-top: 0;
}
...
div#amenities .cursor-arrow  {display:inline-block; vertical-align:bottom; transform:translate(0 ,0 );}
div#amenities .galArrowRight {margin-right:5px;}
.slidesWrap.wrapper2, .slidesWrap.wrapper3  {display:none;}
div#amenities .cursor-arrow {opacity:1;}      
div#amenities .arrow::before {transform:translateY(-50%) rotate(45deg); left:10px; top:6px;}
div#amenities .arrow::after {transform:translateY(50%) rotate(-45deg); left:10px; top:15px;}
...
<div class="scroller" id="scroller">
        <div class="banner amenitiesbanner box" style="">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-5 offset-7">
                        <p class="">With established social infrastructures well-within reach, Hyde Park Resorts is a haven of convenience.
No landmark is far from home for you due to well-connected roadways.</p>
        ...
        <div class="absec l-grey pad80 relative box">
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1366.17 674.03"><defs><style type="text/css">.cls-1{fill:none;stroke:#15110f;stroke-miterlimit:10;stroke-width:0.5px;}.cls-2{fill:#15110f;}</style>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-11">
               ...
               <section class="frame3 section slick-slider"> <img src="images/gallery-txt.png" class="txtImg animated speed1" alt="Gallery">
   
     <div class="arrows"> 
   <a href="javascript:;" class="galArrowLeft cursor-arrow"> 
                <span class="bar"></span>
                <span class="arrow"></span></a> 
   <a href="javascript:;" class="galArrowRight cursor-arrow"> 
                <span class="bar"></span>
                <span class="arrow"></span></a> 
   </div>
   ...
   <button class="slick-prev slick-arrow galArrowLeft" aria-label="Previous" type="button" >Previous</button>
   
      <div class="slidesWrap sliderWipe wrapper2 js_wiper2">
      <ul class="myslides">
          
        
     <li class="myslide"><img src="images/amenities/Multi-Cuisine-Restaurant.jpg?v=2"><h5 class="animated speed5 fadeInUp">Multi Cuisine Restaurant</h5></li>
      
      <li class="myslide"><img src="images/amenities/Separate-PET-Area.jpg?v=2"><h5 class="animated speed5 fadeInUp">Separate PET Area</h5></li>
      
      <li class="myslide"><img src="images/amenities/Sports-Arena.jpg?v=2"><h5 class="animated speed5 fadeInUp">Sports Arena</h5></li>
    ...
    <div class="slidesWrap sliderWipe wrapper1 js_wiper">
      ...
      <li class="myslide"><img src="images/amenities/Jogging-Track-l.jpg?v=2"><h5 class="animated speed5 fadeInUp">Jogging Track</h5></li>
      
      <li class="myslide"><img src="images/amenities/Outdoor-Pool-l.jpg?v=2"><h5 class="animated speed5 fadeInUp">Outdoor Pool</h5></li>
      
      <li class="myslide"><img src="images/amenities/Tennis-Courts-l.jpg?v=2"><h5 class="animated speed5 fadeInUp">Tennis Courts</h5></li>
    ...
    <div class="slidesWrap sliderWipe wrapper3 js_wiper3">
      ...
      <li class="myslide"><img src="images/amenities/Gymnasium.jpg?v=2"><h5 class="animated speed5 fadeInUp">Gymnasium</h5></li>
      
      <li class="myslide"><img src="images/amenities/High-End-Spa.jpg?v=2"><h5 class="animated speed5 fadeInUp">High End Spa</h5></li>
      
      <li class="myslide"><img src="images/amenities/Kids-Play-Area.jpg?v=2"><h5 class="animated speed5 fadeInUp">Kids's Play Area</h5></li>
      
      
      </ul>
    </div>
      <button class="slick-next slick-arrow galArrowRight" aria-label="Next" type="button" >Previous</button>
